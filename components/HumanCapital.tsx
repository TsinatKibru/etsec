...
const HumanCapital = () => {
  ...
  return (
    <div className="flex flex-col items-center px-4 md:px-56 py-14 bg-gradient-to-b from-white to-blue-50">
      <h1
        className="text-2xl md:text-4xl font-bold font-serif mb-8 md:mb-12 text-center text-black mt-10 md:mt-16"
        data-aos={"fade-left"}
      >
        Our Human Capital and Personnel Capability
      </h1>
      <p
        className="text-base md:text-xl text-center px-2 md:px-48 mb-8"
        data-aos={"fade-down"}
      >
      ...
      <div className="flex flex-col md:flex-row items-center w-full mt-10 md:mt-20">
        <div className="flex flex-col items-start md:w-1/2 space-y-6 mb-10 md:mb-0 font-sans">
          <div
            className="p-4 bg-gray-50 rounded-lg w-full"
            data-aos={"fade-right"}
          >
            ...
            <h2 className="text-sm md:text-xl text-gray-500 brightness-75 mb-2">
              The majority of our team are dedicated male professionals,
              committed to exceptional protection.
            </h2>
          </div>
          <div
            className="p-4 bg-gray-50 rounded-lg w-full"
          ...
          >
            ...
            <h2 className="text-sm md:text-xl text-gray-500 brightness-75 mb-2">
              Our team includes skilled female professionals, enhancing
              diversity and strength in our services.
            </h2>
          </div>
          <div
            className="p-4 bg-gray-50 rounded-lg w-full"
          ...
          >
            ...
            <h2 className="text-sm md:text-xl text-gray-500 brightness-75 mb-2">
              Our military-trained personnel bring extensive experience and
              expertise to our security operations.
            </h2>
          </div>
        </div>
