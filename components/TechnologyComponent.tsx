    ...
    <div className="flex flex-col items-center  md:px-44 py-14 pb-28">
      ...
      <div className="flex flex-col md:flex-row w-full space-x-10">
        ...
        <div className="md:w-1/2 pr-5 md:pl-10">
          <h2 className="text-2xl font-semibold font-serif mb-6 text-black text-start">
          ...
          {descriptions.map((desc, index) => (
            <div
              ...
              className={`p-4 mb-6 rounded-lg shadow-lg cursor-pointer transition-colors duration-300 ${
                selectedImage === desc.image
                  ? "border-2 border-blue-500"
                  : "border"
              }`}
            >
              <div className="flex items-center mb-4">
                <div className="text-2xl text-blue-500 mr-4">{desc.icon}</div>
